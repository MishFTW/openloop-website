...
<div id="image-section" class="image-section" <?php if( false == $coni_enable_section ): echo 'style="display: none;"'; endif ?>>
    ...
    <div class="image-text">
        ...
        <h2 class="section-title wow fadeInUp" style="color:#fff"><?php  echo esc_html( get_theme_mod( 'coni_image_title', __( 'Donec id elit non mi porta gravida at eget metus', 'coni' ) ) ); ?></h2>
        <?php
        $wp_kses_args = array(
		    'a' => array(
		        'href' => array(),
